...
from omni.isaac.lab_tasks.manager_based.manipulation.door import mdp

from omni.isaac.lab_tasks.manager_based.manipulation.door.door_env_cfg import (  # isort: skip
...
@configclass
class FrankaCabinetEnvCfg(DoorEnvCfg):
