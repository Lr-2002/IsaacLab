...
from omni.isaac.lab_tasks.manager_based.manipulation.washer import mdp 
from omni.isaac.lab_tasks.manager_based.manipulation.washer.washer_env_cfg import (
...
@configclass
class FrankaWasherEnvCfg(WasherEnvCfg):
...
@configclass
class FrankaWasherEnvCfg_PLAY(FrankaWasherEnvCfg):
    def __post_init__(self):
        super().__post_init__()
